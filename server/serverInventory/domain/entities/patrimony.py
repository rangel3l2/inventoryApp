...
class Patrimony(Patrimony):
    def __init__(self, codbar : int= None, dt_inventario=None, observacao: str=None, responsavel: str=None, setor_responsavel: str=None, status=None, inventariante_id=None, local_encontrado_id=None, local_id=None, produto_id=None):
        self.codbar = codbar

...
export default function CustomErrorModal(props: props) {
    ...
    useEffect(() => {
      ...
      const animateDialog = (isVisible: boolean) => {
        Animated.timing(translateX, {
          toValue: isVisible ? -width / 7 : 0, // Adjust offset as needed
          duration: 500,
  ...
  return (
    ...
    <Text style={[styles.localText,{color: theme.text}]}>{props.message}</Text>     
